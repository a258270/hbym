...
<script type="text/javascript" src="${ctxPath}/static/plugin/h-ui/lib/kindeditor/kindeditor-all.js?v=${v}"></script>
...
<#--<script type="text/javascript" src="${ctxPath}/static/plugin/h-ui/lib/bootstrap-fileinput/js/fileinput.min.js?v=${v}"></script>
<script type="text/javascript" src="${ctxPath}/static/plugin/h-ui/lib/bootstrap-fileinput/js/locales/zh.js?v=${v}"></script>
<link rel="stylesheet" type="text/css" href="${ctxPath}/static/plugin/h-ui/lib/bootstrap-fileinput/css/fileinput.min.css?v=${v}" />
<script type="text/javascript" src="${ctxPath}/static/plugin/h-ui/lib/bootstrap-fileinput/themes/explorer/theme.js?v=${v}"></script>
<link rel="stylesheet" type="text/css" href="${ctxPath}/static/plugin/h-ui/lib/bootstrap-fileinput/themes/explorer/theme.css?v=${v}" />-->
<!-- 公共引入end -->
<!--[if lt IE 9]>
<script type="text/javascript" src="${ctxPath}/static/plugin/h-ui/lib/html5shiv.js?v=${v}"></script>
<script type="text/javascript" src="${ctxPath}/static/plugin/h-ui/lib/respond.min.js?v=${v}"></script>
<![endif]-->
...
<!--[if IE 6]>
<script type="text/javascript" src="${ctxPath}/static/plugin/h-ui/lib/DD_belatedPNG_0.0.8a-min.js?v=${v}" ></script>
<script>DD_belatedPNG.fix('*');</script>
<![endif]-->
<script language="JavaScript">
    var ctxPath = "${ctxPath}";
    var pageNumber = "${baseSetting.pageNumber}";
</script>
<script type="text/javascript" src="${ctxPath}/static/base/include/app_service.js?v=${v}" ></script>
