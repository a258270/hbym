    ...
    <form action="${ctxPath}/plant/user/api/examinee" method="post" id="examineeForm">
        <div class="row" style="margin-left: 30px;">
            <div class="col-md-9" style="padding: 20px 100px 20px 20px">
                ...
                <p style="border-bottom:1px solid #CECECE;padding: 20px 10px">
                    <span>考试所在地：</span>
                    <select style="border-radius: 5px;padding: 2px 50px;" class="xuexiaomingcheng" name="EXAMAREA">
                ...
                <p style="border-bottom:1px solid #CECECE;padding: 20px 10px">
                    ...
                    <input type="number" style="outline: none;border-radius: 5px;border: 1px solid #CECECE;" min="0" id="EXAMSCORE" name="EXAMSCORE" <#if examinee?? && examinee.EXAMSCORE??>value="${examinee.EXAMSCORE}" </#if> /> <span style="color: #ab0000">该成绩用于模拟填报、智能推荐等相关功能</span>
                </p>
                <p style="border-bottom:1px solid #CECECE;padding: 20px 10px">
                ...
                <p style="border-bottom:1px solid #CECECE;padding: 20px 10px">
                    ...
                    <input type="number" style="outline: none;border-radius: 5px;border: 1px solid #CECECE;" min="0" id="FIRSTMOCK" name="FIRSTMOCK" <#if examinee?? && examinee.FIRSTMOCK??>value="${examinee.FIRSTMOCK}" </#if> /> <span style="color: #ab0000">该成绩用于高校检索查询</span>
                </p>
                <p style="border-bottom:1px solid #CECECE;padding: 20px 10px">
                    <span style="margin-right: 17px;">二模成绩：</span>
                    <input type="number" style="outline: none;border-radius: 5px;border: 1px solid #CECECE;" min="0" id="SECONDMOCK" name="SECONDMOCK" <#if examinee?? && examinee.SECONDMOCK??>value="${examinee.SECONDMOCK}" </#if> /> <span style="color: #ab0000">该成绩用于高校检索查询</span>
                </p>
                <p style="border-bottom:1px solid #CECECE;padding: 20px 10px">
                    <span style="margin-right: 17px;">三模成绩：</span>
                    <input type="number" style="outline: none;border-radius: 5px;border: 1px solid #CECECE;" min="0" id="THIRDMOCK" name="THIRDMOCK" <#if examinee?? && examinee.THIRDMOCK??>value="${examinee.THIRDMOCK}" </#if> /> <span style="color: #ab0000">该成绩用于高校检索查询</span>
                </p>
