            ...
            <div class="tab-pane active" role="tabpanel" id="home">
                <div class="kd-kzhu">
                    <div class="kd-xld">
                        ...
                        <div class="kd-xxi">
                            <p>
                                <a class="kd-xhua" href="javascript:void (0);">王老师给您发来了<span>3</span>条消息，快去看看吧！</a>
                            </p>
                            <p class="kd-lxx">自从人类诞生以来一直无休止的向地球母亲索取着各种资源。</p>
                        </div>
                        <div class="kd-xxi">
                            <p>
                                <a class="kd-xhua" href="javascript:void (0);">王老师给您发来了<span>3</span>条消息，快去看看吧！</a>
            ...
            <div class="tab-pane" role="tabpanel" id="messages">
                <div class="kd-kzhu">
                    <div class="kd-xld">
                        ...
                        <div class="kd-tzhi">
                                <span class="kd-yji">
                                    <span>【通知】</span>同学你好，来我们学校看看吧，我们学校就是和要你这样的学生。
                                </span>
                            <a class="kd-xhua" href="javascript:void(0);">点击跳转</a>
                        </div>
                    </div>
                </div>
            </div>
