...
$(function () {
    tab = $("#tab").dataTable({
        ...
        "render" : function (data, type, row, meta) {
            var innerStr = "";
            if(EDIT_QX) {
                innerStr += "<a title='编辑' href='javascript:;' onclick='edit(\"" + row.ARTICLE_ID + "\")' class='ml-5' style='text-decoration:none'><i class='Hui-iconfont'>&#xe6df;</i></a>";
            }
            if(DEL_QX) {
                innerStr += "<a title='删除' href='javascript:;' onclick='del(\"" + row.ARTICLE_ID + "\")' class='ml-5' style='text-decoration:none'><i class='Hui-iconfont'>&#xe6e2;</i></a>";
            }
            return innerStr;
            }
        }
        ...
        "sAjaxSource" : ctxPath + "/admin/article/api/getarticles?now=" + new Date().getTime(),
        //服务器端，数据回调处理
...
//新增院校资料
var add = function () {
    showWindow("新增院校资料", ctxPath + "/admin/article/add");
};
...
var batchdel = function () {
    ...
    layer.confirm("确定要批量删除？", {
        ...
        sendRequest(ctxPath + "/admin/article/api/batchremoves", {batchremoves : batchremoves}, "POST", successFn);
    });
};
...
var onTableQuery = function () {
    var params = {};
    params.SCHOOL_ID = $('#SCHOOL_ID').val();
    tableQuery(tab, params);
};

//编辑院校资料
var edit = function (id) {
    showWindow("编辑院校资料", ctxPath + "/admin/article/edit/" + id);
};
...
var del = function (id) {
    layer.confirm("确定要删除？", {
        ...
        layer.close(index);
        sendRequest(ctxPath + "/admin/article/api/batchremoves", {batchremoves : id}, "POST", successFn);
    });
};