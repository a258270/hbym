...
$(function(){
    ...
    // 匹配用户名，以字母开头，长度在6-16之间，只能包含字符、数字和下划线。
    jQuery.validator.addMethod("isUname", function(value, element) {
        return this.optional(element) || /^[a-zA-Z0-9][a-zA-Z0-9_]{4,14}$/.test(value);
    }, "以字母或数字开头，长度在6-16之间，只能包含字符、数字和下划线。");

    // 匹配密码，以字母开头，长度在6-16之间，只能包含字符、数字和下划线。      
    jQuery.validator.addMethod("isPwd", function(value, element) {       
         return this.optional(element) || /^[a-zA-Z][a-zA-Z0-9_]{4,14}$/.test(value);
