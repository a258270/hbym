        ...
        <#--<div class="row">-->
            <#--<div style="padding: 5px 5px 5px 15px" class="col-md-5 col-sm-5 col-xs-5">-->
                <#--<div style="font-size: 10px">-->
                    ...
                    <#--</span>-->
                <#--</div>-->
                <#--&lt;#&ndash;<div class="colleges">&ndash;&gt;-->
            ...
            <#--<div class="col-md-3 col-sm-3 col-xs-3">-->
                ...
                <#--&lt;#&ndash;<input class="suo" type="submit" value="">&ndash;&gt;-->
                <#--&lt;#&ndash;<i class="glyphicon glyphicon-search kd-ydong"></i>&ndash;&gt;-->
                    ...
                    <#--<#if Session.session_user_key?? && Session.session_user_key.USERNAME??>-->
                        ...
                        <#--<ul class="eject row">-->
                            ...
                            <#--<li class="col-md-8 col-sm-8 col-xs-8">-->
                                ...
                                <#--</a>-->
                            <#--</li>-->
                        <#--&lt;#&ndash;<#if Session.session_user_key?? && !Session.session_user_key.OVERDUETIME?? && Session.session_user_key.ROLE_ID == 'sja4gc59bg'>-->
                                        ...
                                        <#--<div class="modal-dialog" role="document">-->
                                            <#--<div class="modal-content" style="width: 500px;">-->
                                                <#--<div class="modal-header">-->
                                                    ...
                                                    <#--<h2>学生注册</h2>-->
                                                    <#--<!--<h4 class="modal-title" id="myModalLabel">Modal title</h4>&ndash;&gt;-->
                                                <#--</div>-->
                                                <#--<form>-->
                                                    <#--<p>-->
            ...
            <#--<div class="col-md-7 col-sm-7 col-xs-7" style="padding: 15px;margin: -10px;">-->
                <#--<ul class="gation">-->
                    ...
                    <#--&lt;#&ndash;${ctxPath}/plant/expert/index&ndash;&gt;-->
                    <#--</li>-->
                    <#--<li class="nalism">-->
                        ...
                        <#--</ul>-->
                    <#--</li>-->
                    <#--<!--<li class="nalism">&ndash;&gt;-->
                    <#--<!--新闻中心&ndash;&gt;-->
                    <#--<!--<ul class="notice">&ndash;&gt;-->
                    <#--<!--<li>&ndash;&gt;-->
                    <#--<!--<a href="#"></a>&ndash;&gt;-->
                    <#--<!--</li>&ndash;&gt;-->
                    <#--<!--</ul>&ndash;&gt;-->
                    <#--<!--</li>&ndash;&gt;-->
                <#--&lt;#&ndash;<li class="nalism left">-->
                    <#--新闻中心-->
                    <#--<ul class="notice">-->
                        <#--<li>-->
                            <#--<a href="#">公告</a>-->
...
<div style="background-color: #33C9B5;">
    <div class="container">
        <ul class="navigation">
            ...
            <li class="home-page d1">
                <a class="locking<#if curPage?? && curPage == 'report'> lockingt</#if>" href="<#if !Session.session_user_key??>javascript:showError('请先登录账号');<#else><#if Session.session_user_key.ROLE_ID?? && Session.session_user_key.ROLE_ID == 'sja4gc59bg'><#if Session.session_user_key.OVERDUETIME??>${ctxPath}/plant/report/report<#else>javascript:showError('您当前不是黄金会员，点击确定前往激活页面', 'authority');</#if><#else>javascript:showError('请确认账号为学生身份');</#if></#if>">模拟填报</a>
