package com.cms4j.base.system.dictionary.service;
...
public class DictionaryService {
    ...
    public List<DataMap> getDictionariesByLevel(Integer level) throws Exception {
        return (List<DataMap>) daoSupport.findForList("DictionaryMapper.getDictionariesByLevel", level);
    }
}
