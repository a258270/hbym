...
<#include "${ctxPath}/base/include/jurisdiction.ftl" />
    ...
    <script type="text/javascript" src="${ctxPath}/static/plant/sitesetting/shiplink/index.js?v=${v}"></script>
</head>
<body>
...
<div class="page-container">
    <div class="text-c">
        名称：
            <input type="text" class="input-text" style="width:150px" placeholder="请输入名称" id="NAME">
