...
$(function () {
    tab = $("#tab").dataTable({
        ...
        "render" : function (data, type, row, meta) {
            var innerStr = "";
            if(EDIT_QX) {
                innerStr += "<a title='编辑' href='javascript:;' onclick='edit(\"" + row.SCSCORE_ID + "\")' class='ml-5' style='text-decoration:none'><i class='Hui-iconfont'>&#xe6df;</i></a>";
            }
            if(DEL_QX) {
                innerStr += "<a title='删除' href='javascript:;' onclick='del(\"" + row.SCSCORE_ID + "\")' class='ml-5' style='text-decoration:none'><i class='Hui-iconfont'>&#xe6e2;</i></a>";
            }
            return innerStr;
            }
        }
        ...
        "sAjaxSource" : ctxPath + "/admin/scscore/api/getscscores?now=" + new Date().getTime(),
        //服务器端，数据回调处理
...
//新增院校录取分
var add = function () {
    showWindow("新增院校录取分", ctxPath + "/admin/scscore/add");
};
...
var batchdel = function () {
    ...
    layer.confirm("确定要批量删除？", {
        ...
        sendRequest(ctxPath + "/admin/scscore/api/batchremoves", {batchremoves : batchremoves}, "POST", successFn);
    });
};
...
var edit = function (id) {
    showWindow("编辑院校录取分", ctxPath + "/admin/scscore/edit/" + id);
};
...
var del = function (id) {
    layer.confirm("确定要删除？", {
        ...
        layer.close(index);
        sendRequest(ctxPath + "/admin/scscore/api/batchremoves", {batchremoves : id}, "POST", successFn);
    });
};