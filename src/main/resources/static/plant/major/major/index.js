...
$(function () {
    tab = $("#tab").dataTable({
        ...
        "render" : function (data, type, row, meta) {
            var innerStr = "";
            if(EDIT_QX) {
                innerStr += "<a title='编辑' href='javascript:;' onclick='edit(\"" + row.MAJOR_ID + "\")' class='ml-5' style='text-decoration:none'><i class='Hui-iconfont'>&#xe6df;</i></a>";
            }
            if(DEL_QX) {
                innerStr += "<a title='删除' href='javascript:;' onclick='del(\"" + row.MAJOR_ID + "\")' class='ml-5' style='text-decoration:none'><i class='Hui-iconfont'>&#xe6e2;</i></a>";
            }
            return innerStr;
            }
        }
        ...
        "sAjaxSource" : ctxPath + "/admin/major/api/getmajors?now=" + new Date().getTime(),
        //服务器端，数据回调处理
...
//新增专业
var add = function () {
    showWindow("新增专业", ctxPath + "/admin/major/add/BMAJOR");
};
...
var batchdel = function () {
    ...
    layer.confirm("确定要批量删除？", {
        ...
        sendRequest(ctxPath + "/admin/major/api/batchremoves", {batchremoves : batchremoves}, "POST", successFn);
    });
};
...
var edit = function (id) {
    showWindow("编辑专业", ctxPath + "/admin/major/edit/" + id);
};
...
var del = function (id) {
    layer.confirm("确定要删除？", {
        ...
        layer.close(index);
        sendRequest(ctxPath + "/admin/major/api/batchremoves", {batchremoves : id}, "POST", successFn);
    });
};