...
<#include "${ctxPath}/base/include/jurisdiction.ftl" />
    <!-- 页面独有文件 -->
    <script type="text/javascript" src="${ctxPath}/static/base/js/user/teacher/add.js?v=${v}"></script>
</head>
<body>
<article class="page-container">
    <form action="${ctxPath}/admin/teacher/api/add" method="post" class="form form-horizontal" id="form">
        <div class="row cl">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9"> <span class="select-box">
				<select class="chosen-select select" size="1" name="SCHOOL_ID" id="SCHOOL_ID">
					...
					<option value="${schoolObj.SCHOOL_ID}">${schoolObj.NAME}</option>
					</#list>
				</select>
				</span>
            </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="" placeholder="请输入职务" id="JOBTYPE" name="JOBTYPE">
            </div>
        </div>
        <div class="row cl">
