...
<article class="page-container">
    <form action="${ctxPath}/plant/teacher/api/upload_video" method="post" class="form form-horizontal" id="form">
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>视频标题：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="" placeholder="请输入视频标题" id="TITLE" name="TITLE">
            </div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <div class=" sp-uploader sp-blue">
                    ...
                    <input type="file" name="URL" size="1"/>
                </div>
            </div>
        </div>
        <div class="row cl">
